...
# 7 "testprogram.c" 2
# 1 "/usr/local/include/libpmem.h" 1 3
# 8 "testprogram.c" 2
...
int main(int argc, char *argv[]){
 ...
 if ((pmemaddr = (void *)pmem_map_file(path, 1024, (1 << 0),
    0666, &mapped_len, &is_pmem)) == 
# 21 "testprogram.c" 3 4
                                    ((void *)0)
# 21 "testprogram.c"
                                        ) {
  ...
  exit(1);
    ...
    if(strcmp (argv[1], "-w") == 0){
        ...
        *(long int *)(pmemaddr + 64) = 100000000;
        ...
        if (is_pmem)
            pmem_wrappersist((pmemaddr), (mapped_len), "testprogram.c", 39);
        else
