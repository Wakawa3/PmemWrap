...
gcc hello_libpmemobjtest4_safepm_pw.c -fsanitize=address -fsanitize-recover=all -lwrappmem -lpmem -lpmemobj
...
./PmemWrap_memcpy.out /mnt/pmem0/test4_safepm_pw /mnt/pmem0/test4_safepm_pw_flushed obj
./a.out /mnt/pmem0/test4_safepm_pw
rm -f /mnt/pmem0/test4_safepm_pw /mnt/pmem0/test4_safepm_pw_flushed